...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../assets/admin/layout2/assets/images/favicon.ico" />
    <link
      href="../assets/admin/layout2/assets/libs/sweetalert2/sweetalert2.min.css"
      rel="stylesheet"
      type="text/css"
      />
      <link
        href="../assets/admin/layout2/assets/css/bootstrap.min.css"
        rel="stylesheet"
        type="text/css"
        />
        <link href="../assets/admin/layout2/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
        <link href="../assets/admin/layout2/assets/css/app.min.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="../assets/admin/layout2/css/menu_admin.css" />
        <!--linkcss-->
        <!--/linkcss-->
            ...
            <ul class="list-unstyled topnav-menu float-right mb-0">
              ...
              <li class="dropdown d-none d-lg-block">
                <a
                  ...
                  >
                  <img
                  src="https://cuocsongaz.com/wp-content/uploads/2019/12/tai-hinh-anh-avatar-la-co-viet-nam-dep-nhat-2.png"
                  alt="user-image"
                  class="mr-1"
                  height="12"
                  />
                  <span class="align-middle"
                    >Việt Nam <i class="mdi mdi-chevron-down"></i>
                  </span>
                </a>
              ...
              <li class="dropdown notification-list">
                ...
                <li class="dropdown notification-list">
                  <a
                    ...
                    >
                    <img
                    src="https://sunglasshutusa.com/hinh-anh-on-thi-vui/imager_14_5068_700.jpg"
                    alt="user-image"
                    class="rounded-circle"
                    />
                    <span class="pro-user-name ml-1">
                      Kim Thông <i class="mdi mdi-chevron-down"></i>
                    </span>
                  </a>
              ...
              <div class="logo-box">
                <a href="index.html" class="logo text-center">
                  <span class="logo-lg">
                    <img src="https://image.shutterstock.com/image-vector/initial-letter-kt-monogram-logo-260nw-756597313.jpg" alt="" height="20" />
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="text-center mt-3">
                          ...
                          Download Now <i class="ml-1 mdi mdi-arrow-right"></i>
                          </button>
                        </div>
                      </div>
                    </div>
                  ...
                  <ul class="metismenu" id="side-menu">
                    ...
                    <li>
                      ...
                      <ul class="nav-second-level" aria-expanded="false">
                        <li>
                          <a href="index.php?controller=categories">Categories</a>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul class="nav-second-level" aria-expanded="false">
                        <li>
                          <a href="index.php?controller=users">User_one</a>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul class="nav-second-level" aria-expanded="false">
                        <li>
                          <a href="index.php?controller=orders">Đơn hàng</a>
                        </li>
                        <li>
 ...
 -->                   <!--  <li>
        ...
        <script src="../assets/admin/layout2/assets/js/app.min.js"></script>
        <script src="../assets/admin/layout2/assets/js/vendor.min.js"></script>
        <!-- Moment  -->
        <script src="..\assets\admin\layout2\assets\libs\moment\moment.min.js"></script>
        <script src="..\assets\admin\layout2\assets\libs\jquery-scrollto\jquery.scrollTo.min.js"></script>
        <script src="..\assets\admin\layout2\assets\libs\sweetalert2\sweetalert2.min.js"></script>
        <!-- Sparkline charts -->
        <script src="..\assets\admin\layout2\assets\libs\jquery-sparkline\jquery.sparkline.min.js"></script>
        <script src="..\assets\admin\layout2\assets\libs\jquery-knob\jquery.knob.min.js"></script>
        <!-- Chat js -->
        <script src="..\assets\admin\layout2\assets\js\pages\jquery.chat.js"></script>
        <!-- TODO js-->
        <script src="..\assets\admin\layout2\assets\js\pages\jquery.todo.js"></script>
        <!-- widgets init js-->
        <script src="..\assets\admin\layout2\assets\js\pages\widgets.init.js"></script>
        <!-- App js -->
        <script src="..\assets\admin\layout2\assets\js\app.min.js"></script>
